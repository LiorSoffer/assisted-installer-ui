...
import { isExternalPlatform } from '../../utils';
...
const isThirdPartyCNI = (networkType: Cluster['networkType']): boolean =>
...
export const CustomManifestsPage = ({
  ...
  const cleanCustomManifests = React.useCallback(async () => {
    ...
    void ClustersService.removeClusterManifests(manifests, cluster.id);
